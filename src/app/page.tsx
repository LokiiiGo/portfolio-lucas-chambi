...
const skills = [
  { name: 'PHP', color: 'bg-[#474A8A]', icon: '🐘' },
  { name: 'JavaScript', color: 'bg-[#FFE100] text-black', icon: '⚡' },
  { name: 'HTML', color: 'bg-[#F1892D]', icon: '🌐' },
  { name: 'REACT', color: 'bg-[#00C4C1]', icon: '⚛️' },
  { name: 'TailwindCSS', color: 'bg-[#5FBCFF]', icon: '🎨' },
  { name: 'CSS', color: 'bg-[#5400C1]', icon: '💅' },
  { name: 'Next.JS', color: 'bg-black', icon: '▲' },
  { name: 'GitHub', color: 'bg-[#202020]', icon: '🐙' },
  { name: 'Git', color: 'bg-[#C54F00]', icon: '📦' },
  { name: 'MySQL', color: 'bg-[#006ECE]', icon: '🗄️' },
]
              ...
              {projects.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-all duration-300 ${
                    index === currentProject ? 'bg-primary w-12' : 'bg-muted'
                  }`}
                />
              ))}
            </div>
